  ...
  return (
    <>
      <div className={styles.Footer}>
        <div>
          ...
          <div className={styles.Footer__flex}>
            ...
            <div>support@HotWheelsindia.com</div>
          </div>
          <div className={styles.Footer__flex}>
            <div>
              <img
      ...
      <div className={styles.Footer__desc}>
        ...
        <p>
          HotWheels is the first startup to obtain a license to operate bike
          ...
          customer experience. HotWheels is now providing our customers a safer
        ...
        <p>
          ...
          Rental). A person who is new to the city uses HotWheels bike rentals
          ...
          from HotWheels. Our offering also extends to electric bikes for rent
          ...
          and travel safely with HotWheels.
        </p>
      </div>
      <div className={styles.Footer__end}>
        <h3>
          ...
          <img
            ...
            alt="love"
          ></img>
          by H<i class="fa-brands fa-firefox" style={{color:"tomato"}}></i>tWheels
        </h3>
      </div>
    </>
  );
